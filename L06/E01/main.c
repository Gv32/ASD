...
//Dimostrazione caso ottimo//

//La soluzione ottima è una soluzione priva di intersezioni con altri intervalli nel vettore, se fosse possibile avere un altra
//qualsiasi intersezione, allora non sarebbe la soluzione ottima